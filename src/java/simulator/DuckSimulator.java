...
import java.simulator.adapters.GooseAdapter;
import java.simulator.adapters.PigeonAdapter;
import java.simulator.animals.*;
import java.simulator.animals.composites.Flock;
import java.simulator.animals.composites.LeaderFlock;
import java.simulator.animals.decorated.QuackCounter;
import java.simulator.animals.decorated.QuackEcho;
import java.simulator.factories.AbstractDuckFactory;
import java.simulator.factories.CountAndEchoDuckFactory;
import java.simulator.factories.CountingDuckFactory;
import java.simulator.factories.DuckFactory;
